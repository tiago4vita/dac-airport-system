...
@Service
public class ListarClientesSaga {

    private static final Logger logger = LoggerFactory.getLogger(ListarClientesSaga.class);

    private final RabbitTemplate rabbitTemplate;
    private final ObjectMapper objectMapper;

    public ListarClientesSaga(RabbitTemplate rabbitTemplate, ObjectMapper objectMapper) {
    ...
    public String execute() {
        try {
            ...
            String responseJson = (String) rabbitTemplate
                    .convertSendAndReceive("cliente.listar", requestJson);
            ...
            JsonNode clientesNode = root.get("clientes");
