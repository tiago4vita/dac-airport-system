...
public class EfetuarReservaConsumer {
    ...
    public Reserva createReserva(EfetuarReservaDTO efetuarReservaDTO) {
        // Auto-generate id (will be generated by JPA)
        String id = null;

        // Auto-generate dataHora
        ZoneId saoPauloZone = ZoneId.of("America/Sao_Paulo");
        LocalDateTime dataHora = ZonedDateTime.now(saoPauloZone).withFixedOffsetZone().toLocalDateTime();
        
        // Auto-generate estado CRIADA
        EstadoReserva estadoCriada = EstadoReserva.fromEnum(EstadoReserva.Estado.CRIADA);
